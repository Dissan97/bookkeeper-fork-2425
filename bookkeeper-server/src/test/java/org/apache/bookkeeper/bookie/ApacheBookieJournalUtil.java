/*
 * Tutti i metodi in questa classe sono metodi presi direttamente dal progetto originale di Apache di Bookkeeper
 * e vengono utilizzati unicamente come utility per i test della classe Journal.
 * (Non è inserita nel package "util" insieme alle altre classi utility perchè nel progetto originale si trovava
 * in questo path, e cambiandolo si "rompono" le dipendenze con la classe JournalChannel)
 */
...
public class ApacheBookieJournalUtil {
